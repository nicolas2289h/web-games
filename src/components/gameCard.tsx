...
const GameCard = ({ delay, img, bg_img, card_h1, card_type, card_p }:CardProps) => {
  return (
    <motion.div variants={variant1(delay)} initial='hidden' whileInView='show' className=" text-center relative rounded-2xl w-full md:w-[30%] basis shrink-0 grow bg-gray-900 bg-opacity-50 p-5">
