...
const Subscribe = () => {
  return (
    <div className=" text-center mx-auto my-20">
      ...
      <input className=" my-4 w-full max-w-3xl text-center py-4 px-10 rounded-full border-2 border-zinc-400 text-white bg-transparent duration-200 outline-teal-500 placeholder:text-white/40" type="text" placeholder="Email Address" /> <br />
